...
1.Understand booking cancellation behavior.
1.Study customer booking and stay behavior.
1.Analyze room types and pricing.
1.Identify common booking channels and market segments.
1.Create KPIs and visualizations to understand the data easily.
